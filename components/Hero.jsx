...
const Hero = () => {
  const downloadCV = () => {
    ...
    link.href = 'https://drive.google.com/file/d/1dmgsCJwwdXPlx4_s2lNR2NFv1llzulSF/view?usp=drive_link'; // Replace with the actual path to your CV file
    link.download = 'Aryan Tiwari_1.6_Year_Cv'; // Change the filename if needed
    link.click();
  };
      ...
      >
        <motion.div className='col-span-7 place-self-center text-center sm:text-left'>
          <h1 className='text-3xl lg:text-5xl text-white font-extrabold mb-2'>
            Hey, I am
            <span className='pt-2 text-4xl lg:text-6xl text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-yellow-400 block mb-1 z-80'>Aryan Tiwari</span>
          </h1>
          ...
          <p className='text-base text-[#AEB7BE]'> I am React Js Developer with Experience in  Frontend , Currently working as Henceforth Solution Pvt Ltd</p>

          <div className=" p-4 space-y-4 lg:space-y-0 lg:flex ">
            <Link href="https://www.linkedin.com/in/aryan-tiwari-457193179/" passHref target="_blank">
              <button
            ...
            <Link href="https://drive.google.com/file/d/1dmgsCJwwdXPlx4_s2lNR2NFv1llzulSF/view?usp=drive_link" passHref target="_blank">
            <button
              // onClick={downloadCV}

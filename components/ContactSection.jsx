...
const ContactSection = () => {
  ...
  const USER_ID = 'LjKaTFJBLDioT2uND';
  const TEMPLATE_ID = 'template_e3jhifa';
  const SERVICE_ID = 'service_s78rzzb';
        ...
        <div className="grid md:grid-cols-2 md:grid-flow-col gap-8 py-8 px-4 xl:gap-16 sm:gap-16 text-white">
          <div>
            ...
            <div className="flex items-center mt-2">
              <a href="https://github.com/aryantiwari12" target="_blank" rel="noopener noreferrer">
                <Image
              ...
              <a href="https://www.linkedin.com/in/aryan-tiwari-457193179/" target="_blank" rel="noopener noreferrer">
                <Image
            ...
            >
             <label htmlFor="name" className="text-white">
              ...
              <input
                ...
                required
                placeholder="aryantiwari.bui@email.com"
              />
